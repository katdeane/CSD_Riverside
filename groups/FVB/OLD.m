...
animals = {'FON01','FOS01','FOS02','FOS03','FOS04',...'FOS05',
    'FOS06','FON02','FON03','FON04'};
...
channels = {...
    ...
    '[20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4]',... S04 % '[19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5]',... S05
...
%           N01         S01         S02         S03         S04         S06        N02       N03       N04          S05
Layer.II = {'[1:3]',    '[1:3]',    '[1:3]',    '[1:5]',    '[1:4]',    '[1:3]',   '[1:7]',  '[1:6]',  '[1:4]'};        %'[1:5]',
%           N01         S01         S02         S03         S04         S06        N02       N03       N04  
Layer.IV = {'[4:8]',    '[4:8]',    '[4:8]',    '[6:9]',    '[5:9]',    '[4:10]',  '[8:12]', '[7:12]', '[5:9]'};   %'[6:11]',
%           N01         S01         S02         S03         S04         S06        N02       N03        N04 
Layer.Va = {'[9:11]',   '[9:12]',   '[9:11]',   '[10:14]',  '[10:14]',  '[11:14]', '[13:15]','[13:16]','[10:12]'};  %'[12:14]',
%           N01         S01         S02         S03         S04         S06        N02       N03        N04 
Layer.Vb = {'[9:11]',   '[13:15]',  '[12:15]',  '[15:17]',  '[15:17]',  '[15:16]', '[16:18]','[17:20]','[13:17]'};  %'[15:17]',
%           N01         S01         S02         S03         S04         S06        N02       N03        N04 
Layer.VI = {'[14:18]',  '[16:18]',  '[16:20]',  '[18:20]',  '[18:20]',  '[17:20]', '[19:21]','[21:22]','[18:23]'}; %'[18:20]',
...
Cond.TreatNoiseBurst1 = {...
    ...
    {'12'},... FOS04 Noiseburst 70db    % {[]},... FOS05 Didn't do a treatment due to it's eye infection 
...
Cond.TreatgapASSR70 = {...
    ...
    {'13'},... FOS02
    {'14'},... FOS03
    {'14'},... FOS04    % {[]},... FOS05 Didn't do a treatment due to it's eye infection 
    {'13'},... FOS06
    {'13'},... FON02 
    {'13'},... FON03
    {'15'},... FON04
...
Cond.TreatgapASSR80 = {...
    ...
    {'14'},... FOS02
    {'13'},... FOS03
    {'13'},... FOS04    % {[]},... FOS05 Didn't do a treatment due to it's eye infection 
    {'14'},... FOS06
    {'14'},... FON02
    {'14'},... FON03
    {'16'},... FON04
...
Cond.TreatTonotopy = {...
    ...
    {[]},... FOS02
    {[]},... FOS03
    {[]},... FOS04    % {[]},... FOS05 Didn't do a treatment due to it's eye infection
    {[]},... FOS06
    {[]},... FON02
    {[]},... FON03
    {[]},... FON04 
...
Cond.TreatNoiseBurst2 = {...
    ...
    {'15'},... FOS04 Noiseburst 70db    % {[]},... FOS05 Didn't do a treatment due to it's eye infection 
    {'15'},... FOS06
