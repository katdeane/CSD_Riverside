...
animals = {'AWT01','AWT02','AWT03','AWT06','AWT07','AWT08','AWT10','AWT11','AWT12','AWT13','AWT14','AWT15','AWT16'};
...
channels = {...
    ...
    '[17 16 18 15 19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4 30 3 31 2 32 1]' ...%10
    '[17 16 18 15 19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4 30 3 31 2 32 1]' ...%11
    '[17 16 18 15 19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4 30 3 31 2 32 1]' ...%12
    '[17 16 18 15 19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4 30 3 31 2 32 1]' ...%13
    '[17 16 18 15 19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4 30 3 31 2 32 1]' ...%14
    '[17 16 18 15 19 14 20 13 21 12 22 11 23 10 24 9 25 8 26 7 27 6 28 5 29 4 30 3 31 2 32 1]' ...%15
    };

%           01          02          03          06          07          08     ... 
Layer.II = {'[1:3]',	'[1:3]',    '[1:4]',	'[1:4]',    '[1:3]',    '[1:2]'}; 
         
Layer.IV = {'[4:11]',	'[4:11]',   '[5:11]',	'[5:12]',   '[4:8]',    '[3:7]'};
     
Layer.Va = {'[12:14]',	'[12:15]',  '[12:14]',	'[13:15]',  '[9:12]',   '[8:10]'};
   
Layer.Vb = {'[15:19]',	'[16:19]',  '[15:18]',	'[16:18]',  '[13:16]',  '[11:16]'};
    
Layer.VI = {'[21:23]',	'[20:21]',  '[19:21]',	'[19:22]',  '[17:23]',  '[17:21]'}; 
