...
animals = {'PMP01', 'PMP02', 'PMP03','PMP04','PMP06','PMP07','PMP08','PMP09'};  
...
Layer.II = {'[1:3]',    '[1:3]',    '[1:4]',    '[1:4]',    '[1:2]',    '[1:3]',    '[1:3]',    '[1:4]'}; 

Layer.IV = {'[4:11]',   '[4:9]',    '[5:10]',   '[5:9]',   '[3:7]',    '[4:7]',    '[4:10]',   '[5:10]'};

Layer.Va = {'[12:16]',  '[10:14]',  '[11:16]',  '[10:15]',  '[8:11]',   '[8:11]',   '[11:13]',  '[11:16]'};

Layer.Vb = {'[17:21]',  '[15:19]',  '[17:20]',  '[16:20]',  '[12:16]',  '[12:15]',  '[14:17]',  '[17:21]'}; 

Layer.VI = {'[22:25]',  '[20:25]',  '[21:26]',  '[21:25]',  '[17:21]',  '[16:20]',  '[18:21]',  '[22:27]'}; 
