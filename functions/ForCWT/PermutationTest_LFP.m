function PermutationTest_LFP(homedir,BatFreq,MouseFreq,whichtest)
...
input = dir(['*_' MouseFreq '_WT_LFP.mat']);
...
for iLay = 1:length(layers)
    ...
    if contains(whichtest, 'Power')
        ...
        BatOut   = getpowerout(BatWT);
        MouseOut = getpowerout(MouseWT);
        
    elseif contains(whichtest, 'Phase')
        
        BatOut   = getphaseout(BatWT);
        MouseOut = getphaseout(MouseWT);
    ...
    savefig(['Observed Difference ' whichtest ' ' layers{iLay} ' ' MouseFreq ' LFP'])
    saveas(gcf, ['Observed Difference ' whichtest ' ' layers{iLay} ' ' MouseFreq ' LFP.pdf'])
    close(h)
    ...
    set(h, 'PaperOrientation', 'landscape');
    set(h, 'PaperUnits', 'centimeters');
    savefig(['Observed t and p ' whichtest ' '  layers{iLay} ' ' MouseFreq ' LFP'])
    saveas(gcf, ['Observed t and p ' whichtest ' '  layers{iLay} ' ' MouseFreq  ' LFP.pdf'])
    close(h)
    ...
    set(h, 'PaperOrientation', 'landscape');
    set(h, 'PaperUnits', 'centimeters');
    savefig(['Full Permutation ' layers{iLay} ' ' MouseFreq ' LFP'])
    saveas(gcf, ['Full Permutation ' whichtest ' ' layers{iLay} ' ' MouseFreq ' LFP.pdf'])
    close(h)
    save(['Permutation ' whichtest ' ' layers{iLay} ' ' MouseFreq  ' LFP.mat'],'pVal','permMean','permSTD')
    ...
    set(h, 'PaperOrientation', 'landscape');
    set(h, 'PaperUnits', 'centimeters');
    savefig(['Permutation ' whichtest ' ' layers{iLay} ' ' osciName{ispec} ' ' MouseFreq ' LFP'])
    saveas(gcf, ['Permutation ' whichtest ' ' layers{iLay} ' ' osciName{ispec} ' ' MouseFreq ' LFP.pdf'])
    close(h)
    save(['Permutation ' whichtest ' ' layers{iLay} ' ' osciName{ispec} ' ' MouseFreq ' LFP.mat'],'pVal','permMean','permSTD')
