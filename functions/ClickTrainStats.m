function ClickTrainStats(homedir,Groups)
...
for iLay = 1:length(layers)
   ...
   xboxPA = [sgl1onpeak; sgl2onpeak; sgl1_10; sgl2_10;...
    ...
    cd PeakPlots
    h = gcf;
    savefig(h,[Groups{1} 'v' Groups{2} '_' layers{iLay} '_ClickTrain']);
    close(h)
    ...
    % Peak Onset
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(sgl1onpeak,sgl2onpeak,1,'right'); % right tail: group 1 bigger
    PeakStats.SON(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 10
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(sgl1_10,sgl2_10,1,'left'); % left, group 2 is bigger
    PeakStats.S10(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 20 
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(sgl1_20,sgl2_20,1,'left');
    PeakStats.S20(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 40 
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(sgl1_40,sgl2_40,1,'left');
    PeakStats.S40(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 80 
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(sgl1_80,sgl2_80,1,'left');
    PeakStats.S80(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];

    % Peak Ratio to onset
    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(sgl1r10,sgl2r10,1,'left'); 
    PeakStats.Srat10(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(sgl1r20,sgl2r20,1,'left'); 
    PeakStats.Srat20(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(sgl1r40,sgl2r40,1,'left'); 
    PeakStats.Srat40(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(sgl1r80,sgl2r80,1,'left'); 
    PeakStats.Srat80(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    % Averaged
    % Peak Onset
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(avg1onpeak,avg2onpeak,1,'right'); % right tail: group 1 bigger
    PeakStats.AON(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 10
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(avg1stk(:,10),avg2stk(:,10),1,'left'); % left, group 2 is bigger
    PeakStats.A10(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 20 
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(avg1stk(:,20),avg2stk(:,20),1,'left');
    PeakStats.A20(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 40 
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(avg1stk(:,40),avg2stk(:,40),1,'left');
    PeakStats.A40(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];
    % Peak 80 
    [P,DF,CD,mean1,mean2,sd1,sd2] = myttest2(avg1stk(:,80),avg2stk(:,80),1,'left');
    PeakStats.A80(count:countto)  = [P;DF;CD;mean1;mean2;sd1;sd2];

    % Peak Ratio to onset
    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(avg1r10,avg2r10,1,'left'); 
    PeakStats.Arat10(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(avg1r20,avg2r20,1,'left'); 
    PeakStats.Arat20(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(avg1r40,avg2r40,1,'left'); 
    PeakStats.Arat40(count:countto) = [P;DF;CD;mean1;mean2;sd1;sd2];

    [P,DF,CD,mean1,mean2,sd1,sd2]   = myttest2(avg1r80,avg2r80,1,'left'); 
