...
for iMeas = 1:length(pupCondList)
    ...
    AVREC   = mean(recCSD,1); 
    % layers
    IItrace = CSD(str2num(Layer.II{subID}),:,:);
    ...
    IVtrace = CSD(str2num(Layer.IV{subID}),:,:);
    ...
    Vatrace = CSD(str2num(Layer.Va{subID}),:,:);
    ...
    Vbtrace = CSD(str2num(Layer.Vb{subID}),:,:);
    ...
    VItrace = CSD(str2num(Layer.VI{subID}),:,:);
